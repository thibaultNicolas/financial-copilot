  ...
  return (
    <main className="min-h-screen bg-background">
      <nav className="border-b border-border px-6 py-4">
        <span className="text-lg font-bold tracking-tight">Financial Copilot</span>
      </nav>
      ...
      <div className="max-w-2xl mx-auto px-6 py-10 space-y-8">
        ...
        {currentStep === 2 && <Step2Accounts onNext={nextStep} onBack={prevStep} />}
        {currentStep === 3 && <Step3RealEstate onNext={nextStep} onBack={prevStep} />}
